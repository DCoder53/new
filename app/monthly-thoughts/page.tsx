...
const WeeklyPage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchWeeklyMessages = async () => {
      try {
        const response = await axios.get<Message[]>('http://localhost:5000/api/messages/monthly');
  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen">
      <h1 className="text-3xl font-bold mb-6 text-gray-800">Thoughts from the Last 30 Days</h1>
